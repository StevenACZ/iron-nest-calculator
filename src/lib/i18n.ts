...
const messages = {
  es: {
    ...
    shot: 'disparo',
    hintKeys:
      'Enter avanza y registra · Tab recorre todos los controles · Q/E o ←/→ cambian la carga · Ctrl/⌘+Z deshace el último disparo · R reinicia y guarda la tanda · C cambia el cañón destino',
  ...
  en: {
    ...
    shot: 'shot',
    hintKeys:
      'Enter advances and logs · Tab moves through all controls · Q/E or ←/→ change the charge · Ctrl/⌘+Z undoes the last shot · R resets and saves the volley · C switches target gun',
